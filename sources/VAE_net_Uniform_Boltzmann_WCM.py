...
def get_network_Uniform_Boltzmann_WCM(img_width, img_height, latentDim):
    ...
    # decoded1 = Conv2DTranspose(3, (3, 3), activation=up_yours_niggers, padding="same")(x)
    # decoded2 = Conv2DTranspose(3, (3, 3), activation=up_yours_niggers, padding="same")(x)



    # decoded = Conv2D(3, (3, 3), activation='sigmoid', padding='same')(x)
    decoder = Model(latentInputs, [decoded1, decoded2], name="decoder")
    ...
    decoded_img1, decoded_img2 = decoder(encoded_img3)
    autoencoder_cnn = Model(inputs=input_img, outputs=[decoded_img1, decoded_img2], name="autoencoder")
