...
def get_network_Gaussian_Boltzmann_RCM(img_rows, img_cols, latent_dim):
#     img_rows = 400
#     img_cols = 400
...
# 10
    ...
    decoder_outputs3 = Conv2D(3, 1, activation='exponential', name='outputs_img3')(deconvolution6)
    decoder_outputs4 = Conv2D(3, 1, activation='exponential', name='outputs_img4')(deconvolution6)
    decoder_outputs5 = Conv2D(3, 1, activation='exponential', name='outputs_img5')(deconvolution6)
    decoder_outputs6 = Conv2D(3, 1, activation='exponential', name='outputs_img6')(deconvolution6)


    decoder = Model(inputs=[inputs_img, inputs_mask, decoder_input], outputs=[decoder_outputs1, decoder_outputs2,decoder_outputs3, decoder_outputs4, decoder_outputs5, decoder_outputs6], name="decoder")
    decoder.summary()


    encoded_img1, encoded_img2, encoded_img3 = encoder([inputs_img, inputs_mask])
    decoded_img1, decoded_img2, decoded_img3, decoded_img4, decoded_img5, decoded_img6 = decoder([inputs_img, inputs_mask,encoded_img3])
    autoencoder = Model([inputs_img, inputs_mask], [decoded_img1, decoded_img2, decoded_img3, decoded_img4, decoded_img5, decoded_img6], name="autoencoder")
    autoencoder.summary()
